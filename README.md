...
- ### 恼人小喇叭群里的恼人小喇叭们（更新时将新增按下“a键”“s键”“f键”“l键”“;键”和只要输入“a”“s”“f”“l”“;”中的其中一个就能切换模式的功能（具体作用见下表）
按下什么键/输入的东西 | 作用
-- | - 
按下“a键”/“a” | 切换成“在输出声音的同时输出大的‘SB’”的模式
按下“s键”/“s” | 切换成“在输出声音的同时输出小的‘SB’”的模式
按下“f键”/“f” | 切换成只发出声音的模式
按下“l键”/“l” | 切换成“在输出声音的同时输出小的‘FUCK YOU’”的模式
按下“;键”/“;” | 切换成“在输出声音的同时输出大的‘FUCK YOU’”的模式
- ### *“TIP”里提出的特性(可能)*
- ### *其他更新(可能没有)*
